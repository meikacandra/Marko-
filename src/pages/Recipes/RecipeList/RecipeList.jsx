...
export default function RecipeList() {
  ...
  // Simulasikan loading sebentar agar UX tidak terlalu instan
  useEffect(() => {
    setLoading(true);
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {/* Header */}
      <div className="mb-5">
        <h1 className="text-xl font-bold text-gray-800">Jelajahi Resep Masakan Indonesia</h1>
      ...
      <form onSubmit={handleSearch} className="relative mb-4">
        ...
        <input
          ...
          placeholder="Cari resep... (contoh: nasi goreng, ayam, soto, tempe)"
